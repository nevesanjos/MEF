...
!
  node_filename = '.././malhas/' // trim ( prefix ) // '_edges.txt'
  element_filename = '.././malhas/' // trim ( prefix ) // '_elements.txt'
  node_rcm_filename = '.././malhas/' // trim ( prefix ) // '_iee_rcm_edges.txt'
  element_rcm_filename = '.././malhas/' // trim ( prefix ) // '_iee_rcm_elements.txt'
!
!  Read the node data.
!
